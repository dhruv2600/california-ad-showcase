...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background font-inter">
      ...
      <section className="relative pt-32 pb-24 px-4 text-center bg-gradient-to-br from-primary/10 via-secondary/5 to-accent/10 bg-cover bg-center bg-no-repeat" style={{ backgroundImage: 'url(/hero-background.png)' }}>
        ...
        <div className="relative z-10 max-w-5xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-3 mb-10">
            ...
            <a href="https://maps.app.goo.gl/RmCoefeBRVZbQETb8" target="_blank" rel="noopener noreferrer">
              <Badge variant="secondary" className="px-5 py-2.5 text-sm font-medium hover:bg-secondary/80 cursor-pointer">📍 Whitefield, Bangalore</Badge>
            </a>
            <a href="https://maps.app.goo.gl/RmCoefeBRVZbQETb8" target="_blank" rel="noopener noreferrer">
              <Badge variant="secondary" className="px-5 py-2.5 text-sm font-medium hover:bg-secondary/80 cursor-pointer">⭐ Rated 5.0 on Google</Badge>
            </a>
          </div>
      ...
      <a
        href="https://wa.me/918310946034?text=Hi%20CA%20Narender%2C%20I%20would%20like%20to%20schedule%20a%20consultation."
        target="_blank"
